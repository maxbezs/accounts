...
This example demonstrate how to use [accounts-js](https://github.com/accounts-js/accounts) with PostgreSQL thanks to the amazing [@maxbezs/typeorm](https://www.npmjs.com/package/@maxbezs/typeorm) plugin built by [@birkir](https://github.com/birkir/)for his awesome project: (https://github.com/birkir/prime)[PrimeCMS].
